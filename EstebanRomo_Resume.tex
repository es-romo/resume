  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Developed user interfaces used by 1M+ people across different projects with Typescript, React, CSS, and Redux. }
        \resumeItem{Designed serverless services that allows residents of Nova Scotia to access their vaccinaton records using Serverless, Redis and Twilio.}
        ...
        \resumeItem{Ported a large legacy codebase from Node.js v9 to v18; enabled the resumption of its development.}
        ...
        \resumeItem{Wrote hundreds of unit and integration tests with Jest; maintained branch coverage above 80\%.}
        ...
        \resumeItem{Created Terraform templates to manage the infrastructure of many projects.}
        ...
        \resumeItem{Headed data migrations of millions of medical records with PostgreSQL and Typeorm.}
